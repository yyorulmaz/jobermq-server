...
namespace JoberMQ.Implementation.Queue.Default
{
    ...
    internal class DefaultMessageQueueClientKeyFree : MessageQueueBase
    {
        ...
        {
            foreach (var message in messageChilds.ChildData.Values)
            {
