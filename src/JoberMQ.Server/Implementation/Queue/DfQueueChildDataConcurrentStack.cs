...
{
    internal class DfQueueChildDataConcurrentStack : IQueueChildDataConcurrentStack
    {
        #region Constructor
        public DfQueueChildDataConcurrentStack(IQueueMainData dataMain)
        {
            this.dataMain = dataMain;
            this.data = new ConcurrentStack<MessageDbo>();
        }
        #endregion
