...
{
    internal class DfJobTransactionText : DfTextRepository<JobTransactionDbo>, IJobTransactionDbText
    {
        public DfJobTransactionText(TextFileConfigModel textFileConfig) : base(textFileConfig)
        {
        }
    }
}
