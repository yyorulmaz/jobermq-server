...
{
    internal class DfEventSubText : DfTextRepository<EventSubDbo>, IEventSubDbText
    {
        public DfEventSubText(TextFileConfigModel textFileConfig) : base(textFileConfig)
        {
        }
    }
}
