...
{
    internal class DfMessageResultText : DfTextRepository<MessageResultDbo>, IMessageResultDbText
    {
        public DfMessageResultText(TextFileConfigModel textFileConfig) : base(textFileConfig)
        {
        }
    }
}
